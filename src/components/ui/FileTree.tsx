    ...
    return (
      ...
      >
        <div className={cn("size-full", className)}>
          {/* Replaced ScrollArea with a standard div for simplicity without shadcn components */}
          <div
            ref={ref}
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "bg-slate-800 absolute left-1.5 h-full w-px rounded-md py-3 duration-300 ease-in-out hover:bg-slate-700 rtl:right-1.5",
        className
      )}
      {...props}
    />
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(
            ...
            className,
            {
              "bg-slate-800/50 text-emerald-400": isSelected && isSelectable,
              "cursor-pointer text-slate-300 hover:text-emerald-300": isSelectable,
    ...
    return (
      <button
        ...
        className={cn(
          ...
          isSelectable ? "cursor-pointer text-slate-400 hover:text-emerald-300" : "cursor-not-allowed opacity-50",
